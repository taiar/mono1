...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Interceptor: {
      ...
      "%": "DOMError|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList|SVGAnimatedString"
    },
    JSBool: {
      "^": "Interceptor;",
    ...
    _StreamController: {
      ...
      }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 4, 0],
      close$0: function(_) {
        var t1 = this._state;
        if ((t1 & 4) !== 0)
    ...
    _ControllerSubscription: {
      "^": "_BufferingStreamSubscription;_controller,_async$_onData,_async$_onError,_onDone,_zone,_state,_cancelFuture,_pending",
      _onCancel$0: function() {
    ...
    _BufferingStreamSubscription: {
      "^": "Object;_async$_onData,_async$_onError,_onDone,_zone<,_state?,_cancelFuture,_pending",
      ...
      _BufferingStreamSubscription$4: function(onData, onError, onDone, cancelOnError) {
        ...
        this._async$_onError = P._registerErrorHandler(onError, t1);
    ...
    _ForwardingStreamSubscription: {
      "^": "_BufferingStreamSubscription;_stream,_subscription,_async$_onData,_async$_onError,_onDone,_zone,_state,_cancelFuture,_pending",
    ...
    _completeRequest_closure: {
      "^": "Closure:1;_captured_request_0,_captured_completer_1",
      call$1: function(e) {
        var t1, t2;
        t1 = P.convertNativeToDart_AcceptStructuredClone(this._captured_request_0.result, false);
        t2 = this._captured_completer_1.future;
        if (t2._state !== 0)
    ...
    Index: {
      ...
      openCursor$4$autoAdvance$direction$key$range: function(receiver, autoAdvance, direction, key, range) {
        return P.ObjectStore__cursorStreamFromResult(receiver.openCursor(range, "next"), autoAdvance);
      },
    ...
    ObjectStore__cursorStreamFromResult_closure: {
      "^": "Closure:1;_captured_request_0,_captured_autoAdvance_1,_captured_controller_2",
      call$1: function(e) {
        var cursor, t1;
        cursor = P.convertNativeToDart_AcceptStructuredClone(this._captured_request_0.result, false);
        t1 = this._captured_controller_2;
        if (cursor == null)
          t1.close$0(0);
        else {
          if (t1._state >= 4)
          ...
          if (this._captured_autoAdvance_1 && (t1._state & 1) !== 0)
            J.next$0$x(cursor);
        }
      }
    },
    OpenDBRequest: {
      ...
      get$onBlocked: function(receiver) {
        return H.setRuntimeTypeInfo(new W._EventStream(receiver, "blocked", false), [null]);
      },
      get$onUpgradeNeeded: function(receiver) {
        return H.setRuntimeTypeInfo(new W._EventStream(receiver, "upgradeneeded", false), [null]);
      },
      $isOpenDBRequest: 1,
    ...
    convertDartToNative_Dictionary_closure: {
      "^": "Closure:19;_captured_object_0",
      call$2: function(key, value) {
        this._captured_object_0[key] = value;
      }
    },
    _convertDartToNative_PrepareForStructuredClone_findSlot: {
      "^": "Closure:8;_captured_values_1,_captured_copies_2",
      call$1: function(value) {
        var t1, $length, i;
    ...
    _convertDartToNative_PrepareForStructuredClone_walk_closure: {
      "^": "Closure:6;_html_common$_box_0,_captured_walk_8",
      call$2: function(key, value) {
        this._html_common$_box_0._captured_copy_0[key] = this._captured_walk_8.call$1(value);
      }
    },
    convertNativeToDart_AcceptStructuredClone_findSlot: {
      "^": "Closure:8;_captured_values_0,_captured_copies_1",
      call$1: function(value) {
        var t1, $length, i, t2;
    ...
    main: [function() {
      ...
      t1 = N.TodoList$();
      t2 = window;
      t2 = t2.indexedDB || t2.webkitIndexedDB || t2.mozIndexedDB;
      (t2 && C.IdbFactory_methods).open$3$onUpgradeNeeded$version(t2, "todo", t1.get$_onUpgradeNeeded(), t1._version).then$1(t1.get$_onDbOpened()).catchError$1(t1.get$_onError());
    }, "call$0", "todo__main$closure", 0, 0, 2],
    TodoList: {
      "^": "Object;_db,_version,_input,_todoItems",
      _onError$1: [function(e) {
        var t1;
        window.alert("Oh no! Something went wrong. See the console for details.");
        window;
        t1 = "An error occurred: {" + H.S(e) + "}";
        if (typeof console != "undefined")
          console.log(t1);
      }, "call$1", "get$_onError", 2, 0, 20],
      _onDbOpened$1: [function(db) {
        this._db = db;
        this._getAllTodoItems$0();
      }, "call$1", "get$_onDbOpened", 2, 0, 21],
      _onUpgradeNeeded$1: [function(e) {
        var db, options;
        db = P.convertNativeToDart_AcceptStructuredClone(H.interceptedTypeCast(J.get$target$x(e), "$isOpenDBRequest").result, false);
        if (J.getInterceptor$x(db).get$objectStoreNames(db).contains("todos") !== true) {
          options = P.LinkedHashMap__makeEmpty();
          options.$indexSet(0, "keyPath", "timeStamp");
          C.Database_methods._createObjectStore$2(db, "todos", options);
        }
      }, "call$1", "get$_onUpgradeNeeded", 2, 0, 22],
      _addTodo$1: function(text) {
        return J.put$1$x(J.objectStore$1$x(J.transaction$2$x(this._db, "todos", "readwrite"), "todos"), P.LinkedHashMap__makeLiteral(["text", text, "timeStamp", C.JSInt_methods.toString$0(Date.now())])).then$1(new N.TodoList__addTodo_closure(this)).catchError$1(new N.TodoList__addTodo_closure0(this));
      },
      _deleteTodo$1: function(id) {
        J.delete$1$x(J.objectStore$1$x(J.transaction$2$x(this._db, "todos", "readwrite"), "todos"), id).then$2$onError(new N.TodoList__deleteTodo_closure(this), this.get$_onError());
      },
      _getAllTodoItems$0: function() {
        J._clearChildren$0$x(this._todoItems);
        J.openCursor$1$autoAdvance$x(J.objectStore$1$x(J.transaction$2$x(this._db, "todos", "readwrite"), "todos"), true).listen$2$onError(new N.TodoList__getAllTodoItems_closure(this), this.get$_onError());
      },
      _renderTodo$1: function(todoItem) {
        var textDisplay, deleteControl, t1, item;
        textDisplay = W._ElementFactoryProvider_createElement_tag("span", null);
        J.set$text$x(textDisplay, J.$index$asx(todoItem, "text"));
        deleteControl = W._ElementFactoryProvider_createElement_tag("a", null);
        t1 = J.getInterceptor$x(deleteControl);
        t1.set$text(deleteControl, "[Delete]");
        t1 = t1.get$onClick(deleteControl);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.TodoList__renderTodo_closure(this, todoItem)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        item = W._ElementFactoryProvider_createElement_tag("li", null);
        J.get$nodes$x(item)._this.appendChild(textDisplay);
        item.appendChild(deleteControl);
        this._todoItems.appendChild(item);
      },
      TodoList$0: function() {
        this._todoItems = document.querySelector("#todo-items");
        this._input = document.querySelector("#todo");
        var t1 = J.get$onClick$x(document.querySelector("input#submit"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new N.TodoList_closure(this)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      },
      static: {TodoList$: function() {
          var t1 = new N.TodoList(null, 2, null, null);
          t1.TodoList$0();
          return t1;
        }}
    },
    TodoList_closure: {
      ...
      call$1: function(e) {
        ...
        value = J.trim$0$s(J.get$value$x(t1._input));
        if (value.length > 0)
          t1._addTodo$1(value);
        J.set$value$x(t1._input, "");
        return;
      }
    },
    TodoList__addTodo_closure: {
      "^": "Closure:1;_captured_this_0",
      call$1: function(_) {
        return this._captured_this_0._getAllTodoItems$0();
      }
    },
    TodoList__addTodo_closure0: {
      "^": "Closure:1;_captured_this_1",
      call$1: function(e) {
        return this._captured_this_1.get$_onError();
      }
    },
    TodoList__deleteTodo_closure: {
      "^": "Closure:1;_captured_this_0",
      call$1: function(e) {
        return this._captured_this_0._getAllTodoItems$0();
      }
    },
    TodoList__getAllTodoItems_closure: {
      "^": "Closure:1;_captured_this_0",
      call$1: function(cursor) {
        this._captured_this_0._renderTodo$1(J.get$value$x(cursor));
      }
    },
    TodoList__renderTodo_closure: {
      "^": "Closure:1;_captured_this_0,_captured_todoItem_1",
      call$1: function(e) {
        return this._captured_this_0._deleteTodo$1(J.$index$asx(this._captured_todoItem_1, "timeStamp"));
      }
    }
  }, 1]];
  setupProgram(dart, 0);
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, void: true}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [,,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.$int, args: [,]}, {func: 1, args: [P.$int]}, {func: 1, args: [P.$int,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [P.Symbol,,]}, {func: 1, args: [P.String,,]}, {func: 1, void: true, args: [,]}, {func: 1, void: true, args: [P.Database]}, {func: 1, void: true, args: [P.VersionChangeEvent]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(N.todo__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(N.todo__main$closure(), a);
